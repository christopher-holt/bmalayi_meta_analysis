---
title: "Unified Analysis of All B. malayi Data"
...
cwd <- getwd()
OUTPUT_DIR=paste0(cwd, "/output_files_unified_analysis")
...
## 10988 Genes, 1261 genes not passing edger filter, leaves 9727 genes. All were differentially expressed
...
## Dendrogram, Supplementary Figure 2
...
pdf(paste0(FIGURE_DIR, "/Supplementary_Figure_2_dendrogram_zscore.pdf"),
    width = 50,
    height = 10)
  plot(tpm_dendrogram)
invisible(dev.off())
...
write_delim(as.data.frame(sample_order), paste0(FILE_DIR, "/sample_order_FINAL.txt"), delim = "\t")
...
pdf(paste0(FIGURE_DIR, "/Figure_1_Unified_Heatmap.pdf"),
    width = 20,
    height = 10)
...
log2tpm.de <- log2tpm.de[as.character(rownames(zscore.log2tpm.de)),as.character(sample_order)]
...
pdf(paste0(FIGURE_DIR, "/log_transformed_version_of_Figure_1.pdf"),
    width = 20,
    height = 10)
heatmap.3(heatmap_matrix,
              col=hmcol,
...
# Figure 5
## Plot Drug Target Genes of Interest
```{r}
## Genes found in Figure 3 source data 4
genes_of_interest <- c("WBGene00230930", "WBGene00220628", "WBGene00227131", "WBGene00224494", "WBGene00234141", "WBGene00234156", "WBGene00223778", "WBGene00222058",
                       "WBGene00229198", "WBGene00249804", "WBGene00223491", "WBGene00224505", "WBGene00223423", "WBGene00228562", "WBGene00228353", "WBGene00228666", 
                       "WBGene00234039", "WBGene00233988", "WBGene00231818", "WBGene00225675", "WBGene00223487", "WBGene00222262", "WBGene00224891", "WBGene00221961",
                       "WBGene00230077", "WBGene00234226", "WBGene00268837", "WBGene00223407", "WBGene00225841", "WBGene00226673", "WBGene00222456", "WBGene00226422", 
                       "WBGene00226345", "WBGene00229678", "WBGene00227595", "WBGene00220358", "WBGene00223999", "WBGene00229641", "WBGene00230892")

zscore.log2tpm.de <- zscore.log2tpm.de[rownames(zscore.log2tpm.de) %in% genes_of_interest,]
...
## Figure 5
pdf(paste0(FIGURE_DIR, "/Figure_5.pdf"),
    width = 20,
    height = 10)
heatmap.3(heatmap_matrix,
              col=hmcol,
...
annotations_for_genes_of_interest <- annotations[annotations$X9 %in% genes_of_interest,]
...
write.table(tpm.de.wgcna %>% rownames_to_column('gene'),
            paste0(FILE_DIR,"/Supplementary_File_3.tsv"), 
            row.names = F,
            col.names = T,
            quote = F,
            sep = "\t")
...
## Genes removed using CPM filter
write.table(rownames(genes_not_passing_edger_filter),
            paste0(FILE_DIR,"/Supplementary_Table_2_genes_not_passing_edger_filter.tsv"), 
            row.names = F,
            col.names = T,
            quote = F,
            sep = "\t")
...
```{r}
combined_zscore_and_geneinfo <- dplyr::left_join(zscore.log2tpm.de %>% rownames_to_column('gene'), geneinfo, by = 'gene')
write.table(combined_zscore_and_geneinfo,
            paste0(FILE_DIR,"/combined_table_with_zscore_and_geneinfo.tsv"), 
            row.names = F,
            col.names = T,
            quote = F,
            sep = "\t")
