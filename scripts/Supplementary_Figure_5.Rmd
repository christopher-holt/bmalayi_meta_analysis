---
title: "Code to Generate Supplementary Figure 5"
...
cwd <- getwd()
OUTPUT_DIR=paste0(cwd, "/output_files_adult_female_sampling")
...
replicates_to_remove <- c("adult.female_a.PRJEB2709", "adult.female_b.PRJEB2709", "adult.female_c.PRJEB2709", "Bm.DEC.AF.1.day_c.PRJNA388112", 
                       "Bm.DMSO.AF.1.day_c.PRJNA388112", "Bm.IVM.AF.1.day_c.PRJNA388112", "Bm.AF.120dpi_a.PRJNA344486", "Bm.AF.120dpi_b.PRJNA344486")
ballesteros_replicates_to_remove <- c("Bm.IVM.0nM.72h_a.PRJNA303987", "jird.2.5d_b.PRJNA294426", "Bm.IVM.100nM.48h_a.PRJNA303987", "Bm.IVM.100nM.48h_b.PRJNA303987",
                                      "Bm.IVM.0nM.48h_b.PRJNA303987", "Bm.IVM.0nM.48h_a.PRJNA303987", "Bm.IVM.300nM.48h_c.PRJNA303986", "Bm.IVM.1uM.48h_a.PRJNA303986")

groups <- groups %>% filter(!(Replicate %in% replicates_to_remove))
groups <- groups %>% filter(!(Replicate %in% ballesteros_replicates_to_remove))
...
pdf(paste0(FIGURE_DIR, "/Supplementary_Figure_4.pdf"),
    width = 20,
    height = 10)
...
pdf(paste0(FIGURE_DIR, "/log_version_of_Supplementary_Figure_4.pdf"),
    width = 20,
    height = 10)
heatmap.3(heatmap_matrix,
              col=hmcol,
